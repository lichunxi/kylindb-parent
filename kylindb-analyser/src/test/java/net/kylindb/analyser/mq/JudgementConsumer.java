 ...
 *
 */
public class JudgementConsumer {
	public static Logger LOG = LoggerFactory
			.getLogger(JudgementConsumer.class);
	...
	public static void main(String[] args){
        ...
        Pattern pattern = Pattern.compile("^events_connection_judgement.*");
				...
				if (!records.isEmpty()){
					try {
						for (ConsumerRecord<String, byte[]> record : records) {
							...
							System.out.println(String.format("requestId=%s, timestamp=%s, pointValue=%s", requestId, timestamp, pointValue));
						}
					} catch (Exception e) {
