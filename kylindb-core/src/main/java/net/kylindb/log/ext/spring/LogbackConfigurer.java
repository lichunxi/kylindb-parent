 ...
 */
package net.kylindb.log.ext.spring;
...
public class LogbackConfigurer {
     ...
     *                                       Thrown
     */
    public static void initLogging(String location, String rootPath) throws FileNotFoundException, JoranException {
        ...
        loggerContext.reset();
        loggerContext.putProperty("logrootpath", rootPath);
