 ...
 */
package net.kylindb.log.ext.spring.web;

import ch.qos.logback.core.joran.spi.JoranException;
import net.kylindb.log.ext.spring.LogbackConfigurer;
        ...
        if (locationParam != null) {
            ...
            for (String location : StringUtils.tokenizeToStringArray(locationParam,
                ...
                try {
                    ...
                    // Initialize
                    LogbackConfigurer.initLogging(location, servletContext.getRealPath("/"));
                    break;
